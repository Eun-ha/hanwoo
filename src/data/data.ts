    ...
    notice: [
      {
        date: "2024-06-07",
        content:
          "[공고] 제20회 횡성한우축제 공간조성 및 운영 용역 우선협상자 선정결과 공고 우선협상자 선정결과 공고 우선협상자 선정결과 공고",
        url: "",
      },
      {
        date: "2024-06-07",
    ...
    programs: [
      {
        ...
        title2: "에코뮤지엄",
        content:
          "주제관을 따라 걸으면 횡성한우의 과거, 현재, 미래를 만날 수 있는 지붕없는 박물관 미래를 만날 수 있는 지붕없는 박물관 미래를 만날 수 있는 지붕없는 박물관",
